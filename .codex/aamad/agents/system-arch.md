...
## Supported Commands
- `*create-sad` — Produce a full SAD using `.codex/aamad/templates/sad-template.md`, covering stakeholders/concerns, viewpoints, quality attributes, architectural decisions, views (logical, process/runtime, deployment, data), risks, and traceability to PRD.
